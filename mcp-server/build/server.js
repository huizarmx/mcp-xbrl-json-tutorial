...
const GET_FACTS_WITH_CURSOR_TOOL = {
...
const GET_FINANCIAL_METRICS_TOOL = {
...
const GET_FINANCIAL_STATEMENT_TOOL = {
...
const GET_FINANCIAL_RATIOS_TOOL = {
...
// API handlers
async function handleGetFacts(params) {
...
async function handleGetFactById(id) {
    try {
...
async function handleGetFactsWithCursor(params) {
...
async function handleGetFinancialMetrics(entity, year, quarter) {
    // Build query string
    const queryParams = new URLSearchParams();
    queryParams.set("entity", entity);
    if (year)
...
async function handleGetFinancialStatement(entity, type, year, quarter) {
    // Build query string
    const queryParams = new URLSearchParams();
    queryParams.set("entity", entity);
    if (type)
...
async function handleCompareEntities(params) {
...
async function handleGetFinancialRatios(entity, year, quarter) {
    // Build query string
    const queryParams = new URLSearchParams();
    queryParams.set("entity", entity);
    if (year)
...
async function handleGetTrendAnalysis(entity, metrics, periods) {
    // Build query string
    const queryParams = new URLSearchParams();
    queryParams.set("entity", entity);
    if (metrics) {
...
async function handleGetConceptById(id) {
    try {
...
async function handleGetConceptLabels(id, lang, role) {
    // Build query string
    const queryParams = new URLSearchParams();
    if (lang)
...
async function handleSearchConcepts(text, language, minSimilarity) {
    // Build query string
    const queryParams = new URLSearchParams();
...
async function handleGetEntityById(id) {
    try {
    ...
    try {
        switch (request.params.name) {
            ...
            case "xbrl_getFinancialMetrics": {
                const { entity, year, quarter } = request.params.arguments;
                return await handleGetFinancialMetrics(entity, year, quarter);
            }
            case "xbrl_getFinancialStatement": {
                const { entity, type, year, quarter } = request.params.arguments;
            ...
            case "xbrl_getTrendAnalysis": {
                const { entity, metrics, periods } = request.params.arguments;
            ...
            case "xbrl_getConceptLabels": {
                const { id, lang, role } = request.params.arguments;
                return await handleGetConceptLabels(id, lang, role);
            }
            case "xbrl_searchConcepts": {
                const { text, language, minSimilarity } = request.params.arguments;
